...
`summarise_popsurv()` calculates $m_h, N_h, m_{hc}, \text{and } \hat{N}_{hc}$. 

`estimate_popsurv()` calcualtes $\hat{V}(\hat{N}_c)$, the true occurrence in the survey sample and confidence intervals.
