...
- $r$ is the set of respondents with condition $c$.
...
- $n$ is the size of set $r$, i.e. number of respondents with condition $c$;
...
which when $\sum\limits_i w_i >> 1$ becomes:
...
- $\alpha$  is the siginificance level;
