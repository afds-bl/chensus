...
`se_summarise()` calculates $m_h, N_h, m_{hc}, \text{and } \hat{N}_{hc}$. 

`se_estimate()` calculates $\hat{V}(\hat{N}_c)$, the true occurrence in the survey sample and confidence intervals.
