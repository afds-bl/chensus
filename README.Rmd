...
Refer to the [package vignette](articles/chensus.html) for detailed examples and use cases.
...
- [chensus](articles/chensus.html) gives detailed examples of how to use the package.
- [Method](articles/Method.html) details the mathematical background of the confidence interval estimates.
