...
`se_estimate()` calculates $\hat{V}(\hat{N}_c)$, the true occurrence in
...
To cite package 'BFSestimates' in publications use:

Guemghar S. *BFSestimates: Estimate totals and confidence intervals from
Bundesamt für Statistik's Surveys*. R package version 0.1.0.

A BibTeX entry for LaTeX users is

@Manual{, title = {BFSestimates: Estimate totals and confidence
intervals from Bundesamt für Statistik's Surveys}, author = {Souad
Guemghar}, note = {R package version 0.1.0}, }
