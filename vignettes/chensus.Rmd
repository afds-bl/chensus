...
or the wrapper function `se_mean_comb()` for all possible combinations of grouping variables `gender` and `interview_lang`:
...
and display a table with total and proportion estimates, using the FSO-formatting of structural survey results:
