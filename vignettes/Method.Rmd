...
This vignette describes the mathematical method for estimating confidence intervals of the structural survey and mobility and trnsport survey.

# Structural survey (*Strukturerhebung* / *relevé structurel*)

From the structural survey data, `se_estimate_total()` estimates:
...
From the survey data, `mzmv_mean()` estimates:
